...
@Path("/clientes")
@RequestScoped
public class ClientesResourceRESTService {
    @Inject
    private Logger log;
    ...
    @Inject
    ClientesRegistration registration;

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public List<Clientes> listAllClientes( 
    		@QueryParam("filter") String nombre) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response createCliente(Clientes cliente) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateCliente(Clientes cliente) {
    	cliente = repository.findById(cliente.getIdCliente());
        Response.ResponseBuilder builder = null;
        try {
            // Validates member using bean validation
            //validateMember(member);
