...
import py.pol.una.ii.pw.service.VentasMasivasRegistration;

@Path("/ventas/masivas")
@RequestScoped
public class VentasMasivasResourceRESTService {
	
	private final String UPLOADED_FILE_PATH = "c:\\filesrest\\ventas\\";
	
	@Inject
	VentasMasivasRegistration registration;
